  ...
  $document.ready(function () {
    ...
    if (plugins.gradientMove.length) {
      ...
      document.onmousemove = function(e) {
        ...
        plugins.gradientMove[0].style.background = "linear-gradient(45deg, #036469 " + (mouseX - blendAmount) + "%,#0a354e " + (mouseX + blendAmount) + "%)";
      };
    }
    ...
    if (plugins.rdNavbar.length) {
      ...
      if ($('.page-skew').length){
        ...
        $("[data-rd-navbar-toggle='.rd-navbar-nav-wrap']").on('click', function(e){
          setTimeout(function(){
            $('.rd-navbar-nav a').shuffleLetters();
          }, 300);
        });
      }
